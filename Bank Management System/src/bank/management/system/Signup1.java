...
public class Signup1 extends JFrame implements ActionListener {
    ...
    long random;
    JTextField nameTextField, fnameTextField, dobTextField, emailTextField, cityTextField, addTextField, stateTextField, pinTextField;
    JButton next;
    ...
    public Signup1() {
        ...
        personDetail.setFont(new Font("Raleway", Font.BOLD, 20));
